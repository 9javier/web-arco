...
import { IntermediaryService, NewProductModel, NewProductsService, WarehousesService, WarehouseService, AuthenticationService, WarehouseModel } from '@suite/services';
...
export class FreeExpiredReservesComponent implements OnInit, AfterViewInit {
