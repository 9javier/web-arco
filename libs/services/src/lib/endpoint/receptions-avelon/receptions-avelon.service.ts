...
export class ReceptionsAvelonService {
  ...
  receptionsUrl: string = `${environment.apiSorter}/reception`;
  getAllProvidersUrl: string = `${environment.apiSorter}/avelonProviders/all`;
  postIsProviderAvailableUrl: string = `${environment.apiSorter}/avelonProviders`;
  urlReception: string = `${environment.apiSorter}/reception/expedition/lines-destiny-impress/blocked`;
