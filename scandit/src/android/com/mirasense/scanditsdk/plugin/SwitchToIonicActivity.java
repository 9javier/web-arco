...
public class SwitchToIonicActivity extends Activity {

  public static Activity switchToIonic;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(resources.getIdentifier("activity_switch_to_ionic", "layout", package_name));
    ...
    ImageButton ibChangeToLaser = findViewById(resources.getIdentifier("ibChangeToLaser", "id", package_name));
    ibChangeToLaser.setOnClickListener(v -> finish());
