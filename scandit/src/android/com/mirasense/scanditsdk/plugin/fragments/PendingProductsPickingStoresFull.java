...
public class PendingProductsPickingStoresFull extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    mainView = inflater.inflate(ScanditSDK.resources.getIdentifier("fragment_pending_products_picking_stores_full", "layout", ScanditSDK.packageName), container, false);
