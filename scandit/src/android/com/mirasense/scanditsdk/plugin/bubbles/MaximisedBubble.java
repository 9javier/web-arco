...
public class MaximisedBubble extends BaseBubble {
    ...
    public MaximisedBubble(Context context, BubbleData bubbleData, String package_name, Resources resources) {
...
//            backgroundDrawable = ContextCompat.getDrawable(context, R.drawable.bg_transparent_black); //#BF000000
...
//                UiUtils.pxFromDp(context, WIDTH), UiUtils.pxFromDp(context, targetHeight)));
        ...
        View view = inflater.inflate(this.resources.getIdentifier("bubble_maximised", "layout", package_name), null);
        view.findViewById(this.resources.getIdentifier("top", "id", package_name)).setBackground(backgroundDrawable);

        ((TextView) view.findViewById(this.resources.getIdentifier("stock_header", "id", package_name))).setTextColor(highlightColor);
...
//        ((TextView) view.findViewById(this.resources.getIdentifier("online_value", "id", package_name))).setText(String.valueOf(bubbleData.getOnline()));
        ...
        ((TextView) view.findViewById(this.resources.getIdentifier("name_value", "id", package_name))).setText(String.valueOf(bubbleData.getName()));
