...
public class MinimisedBubbleReferenceSerauto extends BaseBubble {
    ...
    public MinimisedBubbleReferenceSerauto(Context context, BubbleData bubbleData, String package_name, Resources resources) {
  ...
  public View getView(Context context, LayoutInflater inflater) {
    ...
    View view = inflater.inflate(this.resources.getIdentifier("bubble_minimised", "layout", package_name), null);
    ...
    if(this.bubbleData.getIdReference().isEmpty()){
